 ...
 */
final class Version20210807214230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD author_id INT DEFAULT NULL, DROP author');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD author VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP author_id');
    }
}
