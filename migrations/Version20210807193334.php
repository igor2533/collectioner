 ...
 */
final class Version20210807193334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD category_id INT DEFAULT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD category VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP category_id');
    }
}
